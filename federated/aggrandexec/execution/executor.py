...
import federated.aggrandexec.channels.job_api_pb2 as job_api_pb2
import federated.aggrandexec.logger.execution as logger
import federated.aggrandexec.config_parser as parser
from federated.aggrandexec import commons
from federated.aggrandexec.channels.channel_context import ClientConnections
from federated.aggrandexec.execution.client import Client
from federated.aggrandexec.execution.data_processor import collate, voice_collate_fn
from federated.aggrandexec.execution.rlclient import RLClient
from federated.aggrandexec.fllibs import *


class Executor(object):
    """Abstract class for federated executor.
    Args:
        args (dictionary): Variable arguments for federated runtime config. defaults to the setup in arg_parser.py
    """
