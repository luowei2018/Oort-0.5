...
import federated.aggrandexec.channels.job_api_pb2 as job__api__pb2
...
class JobServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CLIENT_REGISTER = channel.unary_unary(
            '/federated.JobService/CLIENT_REGISTER',
...
def add_JobServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        'federated.JobService', rpc_method_handlers)
...
class JobService(object):
    ...
    def CLIENT_REGISTER(request,
                        ...
                        timeout=None,
                        metadata=None):
        return grpc.experimental.unary_unary(request, target, '/federated.JobService/CLIENT_REGISTER',
    ...
    def CLIENT_PING(request,
                    ...
                    timeout=None,
                    metadata=None):
        return grpc.experimental.unary_unary(request, target, '/federated.JobService/CLIENT_PING',
    ...
    def CLIENT_EXECUTE_COMPLETION(request,
                                  ...
                                  timeout=None,
                                  metadata=None):
        return grpc.experimental.unary_unary(request, target, '/federated.JobService/CLIENT_EXECUTE_COMPLETION',
